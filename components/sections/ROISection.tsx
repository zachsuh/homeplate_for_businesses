    ...
    <section className="max-w-[1280px] mx-auto px-20 py-20 grid grid-cols-2 gap-20 items-center" id="roi">
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          className="inline-flex items-center gap-2 bg-[#E8470A] text-white px-5 py-2.5 rounded-xl text-[14px] font-semibold no-underline mb-8 hover:bg-[#C73D08] transition-colors"
        >
        ...
        <div className="bg-white border border-[#E4E2DE] rounded-2xl p-6">
          <div className="flex items-center gap-2 text-[13px] font-semibold text-[#3F3F46] mb-5">
            <FileText size={15} className="text-[#E8470A]" />
            ROI Calculator
          </div>

          <div className="mb-5">
            <div className="flex justify-between text-[13px] font-medium text-[#18181B] mb-2">
              <span>Meals per week</span>
              <span className="text-[#E8470A] font-bold">{meals}</span>
            </div>
            <input
          ...
          <div className="mb-5">
            <div className="flex justify-between text-[13px] font-medium text-[#18181B] mb-2">
              ...
              <span className="text-[#E8470A] font-bold">${price}</span>
            </div>
            <input
          ...
          <motion.div
            ...
            className="bg-orange-50 rounded-xl px-4 py-3.5"
          >
            <div className="text-[23px] font-black text-[#18181B]">
            ...
            <div className="mt-2 pt-2 border-t border-[#E4E2DE] text-[12px] text-[#71717A]">
              ...
              <strong className="text-[#18181B] text-[14px]">
                ${shareMin.toLocaleString()}–${shareMax.toLocaleString()}
              </strong>
              <br />New hires required:{" "}
              <strong className="text-[#18181B]">0</strong>
            </div>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 flex-1">
          {[
            { num: "14", name: "Margaret Chen", diet: "Diabetic Protocol", tag: "Active", tagStyle: "bg-orange-50 text-orange-600", freq: "Weekly", delivery: "Mon & Thu", ins: "MA Plan A" },
            { num: "15", name: "Jack Williams", diet: "Renal Protocol", tag: "Active", tagStyle: "bg-orange-50 text-orange-600", freq: "Daily", delivery: "7 meals/wk", ins: "Self-pay" },
            ...
            { num: "17", name: "Robert Davis", diet: "Dysphagia", tag: "Active", tagStyle: "bg-orange-50 text-orange-600", freq: "Daily", delivery: "$98/wk", ins: "MA Plan B" },
          ].map((sub) => (
            <motion.div
              key={sub.num}
              whileHover={{ scale: 1.02 }}
            ...
            >
              ...
              <div className="text-[14px] font-bold text-[#18181B] mb-0.5">{sub.name}</div>
